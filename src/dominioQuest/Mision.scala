...
//  def realizarMision(unEquipo:Equipo):ResultTarea = { //podemos devolver un equipo o lo que sea que devuelva una recompensa, o un exception de que no logro hace la mision
